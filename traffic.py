...
# Changing it ( 'DateTime' ) column to datetime format
...
# create the function to create a new column 'traffic_light_state'
...
# Dividding the dataset into training and testing sets
...
firstNumber= input("Juntion: ")
secondNumber= input("Vehicles: ")
thirdNumber = input("hour: ")
fourthNumber = input("day_of_week: ")
month = input("month: ")
new_data = {
    'Junction': [firstNumber],
    'Vehicles': [secondNumber],
    'hour': [thirdNumber],
    'day_of_week': [fourthNumber],
    'month': [month]
}
